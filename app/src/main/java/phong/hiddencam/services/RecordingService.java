package phong.hiddencam.services;
...
import phong.hiddencam.VideoCodec;
import phong.hiddencam.ui.LocationHelper;
import phong.hiddencam.ui.RecordsAdapter;
...
public class RecordingService extends Service {
    ...
    public class CaptureSessionCallback extends CameraCaptureSession.StateCallback {
        ...
        public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
            Log.i(TAG, "onConfigured: " + cameraCaptureSession);
...
//                mediaRecorder.resume();
    ...
    private void processLatestVideoFileWithWatermark() {
        ...
        if (latestVideoFile != null) {
            ...
            String outputFilePath = latestVideoFile.getParent() + "/HiddenCam_" + originalFileName;
    ...
    private void addTextWatermarkToVideo(String inputFilePath, String outputFilePath) {
        ...
        switch (watermarkOption) {
            ...
            case "no_watermark":
                ...
                return;
            default:
                watermarkText = "Captured by HiddenCam - " + getCurrentTimestamp() + (isLocationEnabled ? locationText : "");
                break;
        }
        ...
        try {
            ...
            captureSession.capture(captureBuilder.build(), new CameraCaptureSession.CaptureCallback() {
                ...
                public void onCaptureCompleted(@NonNull CameraCaptureSession session, @NonNull CaptureRequest request, @NonNull TotalCaptureResult result) {
                    ...
                    Toast.makeText(RecordingService.this, "Image Captured", Toast.LENGTH_SHORT).show();
                }
            }, null);
        } catch (CameraAccessException e) {
            e.printStackTrace();
    ...
    private void saveImage(byte[] bytes) {
        ...
        try {
            // Scoped storage for Android 10+ (API Level 29+)
